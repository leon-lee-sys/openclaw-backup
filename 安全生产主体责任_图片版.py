...
def add_image_placeholder(slide, left, top, width, height, caption, image_path_hint=""):
    """添加图片占位框"""
...
# 封面添加图片占位
add_image_placeholder(slide1, Inches(3.5), Inches(3.5), Inches(3), Inches(2), "安全发展图片", "")

subtitle = slide1.shapes.add_textbox(Inches(1), Inches(5.8), Inches(8), Inches(1))
...
add_image_placeholder(slide3, Inches(6.5), Inches(1.5), Inches(3), Inches(2), "安全生产宣传图片")
...
for item in xi_content:
    ...
    p.font.color.rgb = RGBColor(51, 51, 51)
    y += 1.2
add_image_placeholder(slide4, Inches(0.5), Inches(6), Inches(2.5), Inches(1), "习近平总书记图片")
...
add_image_placeholder(slide6, Inches(6), Inches(1.5), Inches(3.5), Inches(2.2), "事故现场图片")
...
add_image_placeholder(slide7, Inches(0.5), Inches(5), Inches(3), Inches(1.8), "安全发展理念图片")
add_slide_number(slide7, 7)

# 第8页：第二部分开场
slide8 = prs.slides.add_slide(prs.slide_layouts[6])
add_title_bar(slide8, "第二部分", RGBColor(0, 100, 80))
p = slide8.shapes.add_textbox(Inches(1), Inches(3), Inches(8), Inches(1.5))
tf = p.text_frame
p2 = tf.paragraphs[0]
p2.text = "安全生产法律法规政策"
p2.font.size = Pt(40)
...
p2.alignment = PP_ALIGN.CENTER
add_image_placeholder(slide8, Inches(3.5), Inches(4.5), Inches(3), Inches(2), "法律法规图片")
...
add_image_placeholder(slide9, Inches(6.5), Inches(1.5), Inches(3), Inches(2), "法律书籍图片")
...
add_image_placeholder(slide10, Inches(0.5), Inches(5.2), Inches(3), Inches(1.8), "安全生产法宣传图片")
...
for d in details:
    ...
    y += 0.55
add_image_placeholder(slide11, Inches(6.5), Inches(3.3), Inches(3), Inches(2), "责任体系图示")
...
for duty in duties:
    ...
    p.font.color.rgb = RGBColor(51, 51, 51)
    y += 0.75
add_image_placeholder(slide12, Inches(6.5), Inches(1.4), Inches(3), Inches(1.8), "企业领导图片")
...
add_image_placeholder(slide13, Inches(6.5), Inches(1.5), Inches(3), Inches(2), "法律天平图片")
...
theme = "\"人人讲安全、个个会应急\""
box = slide14.shapes.add_shape(MSO_SHAPE.ROUNDED_RECTANGLE, Inches(1.5), Inches(2), Inches(5), Inches(1.5))
box.fill.solid()
...
y = 3.8
for pt in points:
    p = slide14.shapes.add_textbox(Inches(0.8), Inches(y), Inches(5), Inches(0.5))
    tf = p.text_frame
    pp = tf.paragraphs[0]
    pp.text = pt
    pp.font.size = Pt(18)
    pp.font.color.rgb = RGBColor(51, 51, 51)
    y += 0.6
add_image_placeholder(slide14, Inches(5.5), Inches(3.5), Inches(4), Inches(3), "安全生产月宣传图片")
...
add_image_placeholder(slide15, Inches(6.5), Inches(1.5), Inches(3), Inches(2.5), "政策文件图片")
...
for line in mechanism:
    p = slide16.shapes.add_textbox(Inches(0.8), Inches(y), Inches(5), Inches(0.5))
    tf = p.text_frame
    pp = tf.paragraphs[0]
    pp.text = line
    pp.font.size = Pt(13)
    if '【' in line:
        ...
        pp.font.color.rgb = RGBColor(51, 51, 51)
    y += 0.45
add_image_placeholder(slide16, Inches(5.5), Inches(1.5), Inches(4), Inches(3), "双重预防机制流程图")
...
for line in investment:
    p = slide17.shapes.add_textbox(Inches(0.8), Inches(y), Inches(5), Inches(0.5))
    tf = p.text_frame
    pp = tf.paragraphs[0]
    pp.text = line
    pp.font.size = Pt(13)
    if '【' in line:
        ...
        pp.font.color.rgb = RGBColor(51, 51, 51)
    y += 0.42
add_image_placeholder(slide17, Inches(5.5), Inches(1.5), Inches(4), Inches(3), "安全投入设施图片")
...
for line in standard:
    p = slide18.shapes.add_textbox(Inches(0.8), Inches(y), Inches(5), Inches(0.5))
    tf = p.text_frame
    pp = tf.paragraphs[0]
    pp.text = line
    pp.font.size = Pt(13)
    if '【' in line:
        ...
        pp.font.color.rgb = RGBColor(51, 51, 51)
    y += 0.45
add_image_placeholder(slide18, Inches(5.5), Inches(1.5), Inches(4), Inches(3), "标准化证书图片")
...
add_image_placeholder(slide19, Inches(6.5), Inches(2), Inches(3), Inches(2), "法律体系图示")
...
p2.font.color.rgb = RGBColor(30, 60, 114)
p2.alignment = PP_ALIGN.CENTER
add_image_placeholder(slide20, Inches(3.5), Inches(4.5), Inches(3), Inches(2), "国际安全会议图片")
...
add_image_placeholder(slide21, Inches(6.5), Inches(1.5), Inches(3), Inches(2), "国际安全标志图片")
...
add_image_placeholder(slide22, Inches(6.5), Inches(1.5), Inches(3), Inches(2), "中国安全生产图片")
...
add_image_placeholder(slide23, Inches(0.5), Inches(5), Inches(2.5), Inches(1.8), "德国工业安全图片")
...
add_image_placeholder(slide24, Inches(6.5), Inches(1.5), Inches(3), Inches(2), "安全差距对比图片")
...
add_image_placeholder(slide25, Inches(6.5), Inches(2), Inches(3), Inches(2), "安全发展图片")
...
p2.font.color.rgb = RGBColor(30, 60, 114)
p2.alignment = PP_ALIGN.CENTER
add_image_placeholder(slide26, Inches(3.5), Inches(4.5), Inches(3), Inches(2), "事故现场警示图片")
...
add_content_box(slide27, meaning, 1.5)
add_image_placeholder(slide27, Inches(6.5), Inches(1.5), Inches(3), Inches(2), "警示教育图片")
...
for line in case1:
    ...
    pp.font.color.rgb = RGBColor(51, 51, 51)
    y += 0.5
add_image_placeholder(slide28, Inches(6.5), Inches(1.4), Inches(3), Inches(2), "泉州酒店坍塌现场图")
...
for line in case2:
    ...
    pp.font.color.rgb = RGBColor(51, 51, 51)
    y += 0.5
add_image_placeholder(slide29, Inches(6.5), Inches(1.4), Inches(3), Inches(2), "十堰燃气爆炸现场图")
...
for line in case3:
    ...
    pp.font.color.rgb = RGBColor(51, 51, 51)
    y += 0.5
add_image_placeholder(slide30, Inches(6.5), Inches(1.4), Inches(3), Inches(2), "长沙自建房倒塌现场图")
...
for line in case4:
    ...
    pp.font.color.rgb = RGBColor(51, 51, 51)
    y += 0.5
add_image_placeholder(slide31, Inches(6.5), Inches(1.4), Inches(3), Inches(2), "长峰医院火灾现场图")
...
for line in case5:
    ...
    pp.font.color.rgb = RGBColor(51, 51, 51)
    y += 0.5
add_image_placeholder(slide32, Inches(6.5), Inches(1.4), Inches(3), Inches(2), "梅大高速塌方现场图")
...
for line in lessons1:
    p = slide33.shapes.add_textbox(Inches(0.8), Inches(y), Inches(9), Inches(0.6))
    tf = p.text_frame
    pp = tf.paragraphs[0]
    pp.text = line
    pp.font.size = Pt(14)
    if '【' in line:
        ...
        pp.font.color.rgb = RGBColor(51, 51, 51)
    y += 0.55
add_image_placeholder(slide33, Inches(6.5), Inches(1.4), Inches(3), Inches(2), "责任缺失图片")
...
for line in lessons2:
    p = slide34.shapes.add_textbox(Inches(0.8), Inches(y), Inches(9), Inches(0.6))
    tf = p.text_frame
    pp = tf.paragraphs[0]
    pp.text = line
    pp.font.size = Pt(14)
    if '【' in line:
        ...
        pp.font.color.rgb = RGBColor(51, 51, 51)
    y += 0.55
add_image_placeholder(slide34, Inches(6.5), Inches(1.4), Inches(3), Inches(2), "监管缺失图片")
...
for line in lessons3:
    p = slide35.shapes.add_textbox(Inches(0.8), Inches(y), Inches(9), Inches(0.6))
    tf = p.text_frame
    pp = tf.paragraphs[0]
    pp.text = line
    pp.font.size = Pt(14)
    if '【' in line:
        ...
        pp.font.color.rgb = RGBColor(51, 51, 51)
    y += 0.55
add_image_placeholder(slide35, Inches(6.5), Inches(1.4), Inches(3), Inches(2), "隐患排查图片")
...
for line in lessons4:
    p = slide36.shapes.add_textbox(Inches(0.8), Inches(y), Inches(9), Inches(0.6))
    tf = p.text_frame
    pp = tf.paragraphs[0]
    pp.text = line
    pp.font.size = Pt(14)
    if '【' in line:
        ...
        pp.font.color.rgb = RGBColor(51, 51, 51)
    y += 0.55
add_image_placeholder(slide36, Inches(6.5), Inches(1.4), Inches(3), Inches(2), "应急演练图片")
...
add_content_box(slide37, reflection, 1.5)
add_image_placeholder(slide37, Inches(6.5), Inches(1.5), Inches(3), Inches(2), "警示标识图片")
...
for line in case_const:
    p = slide38.shapes.add_textbox(Inches(0.8), Inches(y), Inches(9), Inches(0.6))
    tf = p.text_frame
    pp = tf.paragraphs[0]
    pp.text = line
    pp.font.size = Pt(14)
    if '【' in line:
        ...
        pp.font.color.rgb = RGBColor(51, 51, 51)
    y += 0.5
add_image_placeholder(slide38, Inches(6.5), Inches(1.4), Inches(3), Inches(2.5), "建筑施工安全图片")
...
add_image_placeholder(slide39, Inches(6.5), Inches(1.5), Inches(3), Inches(2.5), "安全防护措施图片")
...
add_image_placeholder(slide40, Inches(6.5), Inches(1.5), Inches(3), Inches(2), "危化品安全图片")
...
add_image_placeholder(slide41, Inches(6.5), Inches(1.5), Inches(3), Inches(2), "矿山安全图片")
...
add_image_placeholder(slide42, Inches(6.5), Inches(2), Inches(3), Inches(2), "安全警示图片")
...
p2.font.color.rgb = RGBColor(30, 60, 114)
p2.alignment = PP_ALIGN.CENTER
add_image_placeholder(slide43, Inches(3.5), Inches(4.5), Inches(3), Inches(2), "安全管理体系图片")
...
for line in philosophy:
    p = slide44.shapes.add_textbox(Inches(0.8), Inches(y), Inches(9), Inches(0.6))
    tf = p.text_frame
    pp = tf.paragraphs[0]
    pp.text = line
    pp.font.size = Pt(15)
    if '【' in line:
        ...
        pp.font.color.rgb = RGBColor(51, 51, 51)
    y += 0.6
add_image_placeholder(slide44, Inches(6.5), Inches(1.4), Inches(3), Inches(2), "安全理念图片")
...
add_image_placeholder(slide45, Inches(6.5), Inches(1.5), Inches(3), Inches(2), "安全文化宣传图片")
...
y = 1.4
for line in dupont:
    p = slide46.shapes.add_textbox(Inches(0.8), Inches(y), Inches(5.5), Inches(0.5))
    tf = p.text_frame
    pp = tf.paragraphs[0]
    pp.text = line
    pp.font.size = Pt(12)
    pp.font.color.rgb = RGBColor(51, 51, 51)
    y += 0.45
add_image_placeholder(slide46, Inches(6), Inches(1.4), Inches(3.5), Inches(3.5), "杜邦安全图片")
...
for line in responsibility:
    p = slide47.shapes.add_textbox(Inches(0.8), Inches(y), Inches(9), Inches(0.6))
    tf = p.text_frame
    pp = tf.paragraphs[0]
    pp.text = line
    pp.font.size = Pt(13)
    if '【' in line:
        ...
        pp.font.color.rgb = RGBColor(51, 51, 51)
    y += 0.5
add_image_placeholder(slide47, Inches(6.5), Inches(1.4), Inches(3), Inches(2.5), "责任体系图示")
...
y = 1.4
for line in system:
    p = slide48.shapes.add_textbox(Inches(0.8), Inches(y), Inches(9), Inches(0.55))
    tf = p.text_frame
    pp = tf.paragraphs[0]
    pp.text = line
    pp.font.size = Pt(12)
    if '【' in line:
        ...
        pp.font.color.rgb = RGBColor(51, 51, 51)
    y += 0.5
add_image_placeholder(slide48, Inches(6.5), Inches(1.4), Inches(3), Inches(2.5), "制度文件图片")
...
add_image_placeholder(slide49, Inches(6.5), Inches(1.4), Inches(3), Inches(2.5), "安全管理组织图片")
...
add_image_placeholder(slide50, Inches(6.5), Inches(1.4), Inches(3), Inches(2.5), "风险评估图片")
...
add_image_placeholder(slide51, Inches(6.5), Inches(1.4), Inches(3), Inches(2.5), "隐患排查图片")
...
add_image_placeholder(slide52, Inches(6.5), Inches(1.5), Inches(3), Inches(2), "监控中心图片")
...
add_image_placeholder(slide53, Inches(6.5), Inches(1.5), Inches(3), Inches(2), "智慧安全图片")
...
add_image_placeholder(slide54, Inches(6.5), Inches(1.4), Inches(3), Inches(2.5), "特种设备图片")
...
add_image_placeholder(slide55, Inches(6.5), Inches(1.4), Inches(3), Inches(2.5), "危化品储存图片")
...
add_image_placeholder(slide56, Inches(6.5), Inches(1.4), Inches(3), Inches(2.5), "应急演练图片")
...
add_image_placeholder(slide57, Inches(6.5), Inches(1.8), Inches(3), Inches(2.5), "应急救援图片")
...
add_image_placeholder(slide58, Inches(6.5), Inches(1.4), Inches(3), Inches(2.5), "安全培训图片")
...
add_image_placeholder(slide59, Inches(6.5), Inches(1.8), Inches(3), Inches(2.5), "承包商管理图片")
...
add_image_placeholder(slide60, Inches(6.5), Inches(1.4), Inches(3), Inches(2.5), "绩效考核图片")
...
add_image_placeholder(slide61, Inches(6.5), Inches(1.6), Inches(3), Inches(2.5), "企业领导安全图片")
...
add_image_placeholder(slide62, Inches(6.5), Inches(1.6), Inches(3), Inches(2.5), "领导检查安全图片")
...
add_image_placeholder(slide63, Inches(6.5), Inches(1.6), Inches(3), Inches(2.5), "现场管理图片")
...
add_image_placeholder(slide64, Inches(6.5), Inches(1.6), Inches(3), Inches(2.5), "安全沟通图片")
...
add_image_placeholder(slide65, Inches(6.5), Inches(1.4), Inches(3), Inches(2.5), "安全决策图片")
...
add_image_placeholder(slide66, Inches(6.5), Inches(1.4), Inches(3), Inches(2.5), "班组安全图片")
...
add_image_placeholder(slide67, Inches(6.5), Inches(1.8), Inches(3), Inches(2.5), "现场安全图片")
...
add_image_placeholder(slide68, Inches(6.5), Inches(1.8), Inches(3), Inches(2.5), "智能安全图片")
...
add_image_placeholder(slide69, Inches(6.5), Inches(2), Inches(3), Inches(2), "安全管理图片")
...
add_image_placeholder(slide70, Inches(6.5), Inches(1.8), Inches(3), Inches(2.5), "责任落实图片")
...
add_image_placeholder(slide71, Inches(6.5), Inches(2), Inches(3), Inches(2), "安全总结图片")
...
for line in requirements:
    ...
    p.font.color.rgb = RGBColor(51, 51, 51)
    y += 0.9
add_image_placeholder(slide72, Inches(6.5), Inches(1.6), Inches(3), Inches(2.5), "工作推进图片")
...
add_image_placeholder(slide73, Inches(0.5), Inches(5.5), Inches(2.5), Inches(1.5), "承诺签名图片")
...
p2.alignment = PP_ALIGN.CENTER
add_image_placeholder(slide74, Inches(3.5), Inches(5.5), Inches(3), Inches(1.5), "安全未来图片")
...
for q in questions:
    ...
    pp.font.color.rgb = RGBColor(51, 51, 51)
    y += 0.8
add_image_placeholder(slide75, Inches(6.5), Inches(1.6), Inches(3), Inches(2.5), "讨论交流图片")
...
add_image_placeholder(slide76, Inches(6.5), Inches(1.6), Inches(3), Inches(2.5), "培训考核图片")
...
add_image_placeholder(slide77, Inches(6.5), Inches(1.6), Inches(3), Inches(2.5), "学习资料图片")
...
add_image_placeholder(slide78, Inches(6.5), Inches(1.8), Inches(3), Inches(2.5), "联系方式图片")
...
p3.alignment = PP_ALIGN.CENTER
add_image_placeholder(slide79, Inches(3.5), Inches(5.5), Inches(3), Inches(1.5), "感谢图片")
...
add_image_placeholder(slide80, Inches(6.5), Inches(2), Inches(3), Inches(2), "附页素材图片")
add_slide_number(slide80, 80)

# 保存
prs.save('/Users/mac/.openclaw/workspace/安全生产主体责任PPT_80页_图片版.pptx')
print("PPT已生成：安全生产主体责任PPT_80页_图片版.pptx")
print(f"共80页，每页均含图片占位符")
